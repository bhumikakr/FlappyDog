...
def initialize_pygame():
    ...
    pygame.display.set_caption("Flappy Sunny")

    return screen

# these images will be called in FlappySunny.py to generate the graphics
def load_images():
    # loading all the images required for the game from the images folder
    # and returning a dictionary of them as following:

    # 'background' : the background
    # 'sunny' : the sunny figure
    # 'sunny2' : the sunny figure
    # 'pipe-up' : the 'pipe' for the upper part, represented by a suspended tennis ball
    # 'pipe-down' : the 'pipe' for the lower part, represented by a pipe
    # 'ground' : the ground
    ...
    return {'background': load_image('background.png'),
            'sunny': load_image('sunny.png'),
            'sunny2': load_image('sunny2.png'),
            'pipe-up': load_image('tennis_ball.png'),
            'pipe-down': load_image('pipe.png'),
